...
import {Modal, TouchableWithoutFeedback, View, ScrollView} from 'react-native';
...
/**
 * @class Overlay
 * @desc Custom Overlay Modal
 * @param children
 * @param animationType
 * @param animationOutType
 * @param easing
 * @param visible
 * @param closeOnTouchOutside
 * @param onClose
 * @param containerStyle
 * @param childrenWrapperStyle
...
class Overlay extends React.Component {
  ...
  /**
   * @desc default props for Overlay component
   * @type {{closeOnTouchOutside: boolean, animationDuration: number, accessible: boolean, onClose: Overlay.defaultProps.onClose, visible: boolean, children: null, animationOutType: string, easing: string, animationType: string}}
   */
  static defaultProps = {
    children: null,
  ...
  /**
   * Animate modal to hide it when an event is triggered
   */
  _hideModal = () => {
